...
func (g *GormGenerator) StartFromDDL(filename string, withCache bool, database string, strict bool) error {
	err := g.GenFromDDL(filename, withCache, database, strict)
	if err != nil {
		return err
	}
	return nil
...
func (g *GormGenerator) GenFromDDL(filename string, withCache bool, database string, strict bool) error {
...
`
	...
	return &codeFile{
		params:      params,
		fileName:    fmt.Sprintf("%s.go", table.Name.ToSnake()),
		ignoreExist: true,
		template:    tmp,
	}
}
